...
To enable the plugin in your project you must add the name of the plugin "accounting-files" as a separated line inside the plugins file located inside config directory (`config/plugins`).
